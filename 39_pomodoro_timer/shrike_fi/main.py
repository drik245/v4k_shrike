"""
Project 39: Pomodoro Productivity Timer (Shrike Fi - ESP32-S3)
...
Wiring:
  TM1637 CLK  -> ESP_IO4
  TM1637 DIO  -> ESP_IO5
  Buzzer (+)  -> ESP_IO6  (active buzzer, other leg to GND)
  Start/Pause -> ESP_IO14 to GND
  Reset       -> ESP_IO7  to GND
...
display   = tm1637.TM1637(clk=Pin(4), dio=Pin(5))
buzzer    = PWM(Pin(6), freq=1000, duty_u16=0)
btn_start = Pin(14, Pin.IN, Pin.PULL_UP)
btn_reset = Pin(7,  Pin.IN, Pin.PULL_UP)
