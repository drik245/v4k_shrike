/*
  Alarm Clock - Shrike Lite (RP2040)

  Offline alarm clock on a TM1637 display with three push buttons.
  Timekeeping is done with millis(), no WiFi needed.
  ...
  Wiring:
    TM1637 CLK   - RP_IO2 (GPIO 2)
    TM1637 DIO   - RP_IO3 (GPIO 3)
    MODE button  - RP_IO4 (GPIO 4, active low, internal pullup)
    UP button    - RP_IO5 (GPIO 5, active low, internal pullup)
    DOWN button  - RP_IO6 (GPIO 6, active low, internal pullup)
    Buzzer       - RP_IO7 (GPIO 7)
